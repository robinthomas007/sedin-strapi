...
export interface ApiPrivacyPolicyPrivacyPolicy extends Schema.SingleType {
  ...
  attributes: {
    ...
    ContactUs: Attribute.Component<'elements.info-card'>;
    ...
    HowInfo: Attribute.Component<'row.info-card-row'>;
    Severability: Attribute.Component<'elements.info-card'>;
    Amendment: Attribute.Component<'elements.info-card'>;
    AutomatedDecision: Attribute.Component<'elements.info-card'>;
    externalLinks: Attribute.Component<'elements.info-card'>;
    externalLinks2: Attribute.Component<'elements.info-card'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTermsAndConditionTermsAndCondition
  ...
  attributes: {
    ...
    definitions: Attribute.Component<'row.info-card-row'>;
    generalTerms: Attribute.Component<'row.info-card-row'>;
    serviceOverview: Attribute.Component<'row.info-card-row'>;
    registration: Attribute.Component<'elements.info-card'>;
    eligibility: Attribute.Component<'row.info-card-row'>;
    content: Attribute.Component<'row.info-card-row'>;
    indemnity: Attribute.Component<'elements.info-card'>;
    terms: Attribute.Component<'row.info-card-row'>;
    communication: Attribute.Component<'row.info-card-row'>;
